...
exports.setupGeneralCommands = setupGeneralCommands;
const gemini_1 = require("../gemini");
function setupGeneralCommands(bot) {
    ...
    bot.command("news", async (ctx) => {
        ...
        const reply = await (0, gemini_1.chatGemini)("لخص أهم وأحدث 3 أخبار عالمية عامة باختصار شديد جداً كعناوين عاجلة.");
