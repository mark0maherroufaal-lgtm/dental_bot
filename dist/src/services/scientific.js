...
exports.processAndFormatArticle = processAndFormatArticle;
const gemini_1 = require("../gemini");
const articles_1 = require("../db/articles");
async function processAndFormatArticle(telegramId, articleText, sourceUrl) {
...
"${articleText}"
`;
    const summary = await (0, gemini_1.chatMainGemini)(prompt);
    ...
    const articleId = await (0, articles_1.addArticleRecord)(articleRecord);
